...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('bootstrap-5.3.0-dist/fontawesome-free-6.7.2-web/css/all.min.css') }}">
...
<body>
    <div class="d-flex justify-content-center align-items-center min-vh-100 "
        style="background: linear-gradient(to bottom, #A0DEF7FF, #FFEEEEFF);">
        <div class="container mt-2 w-85 bg-white p-2 rounded-3 shadow">
            @if(session('success'))

...
@section('content')
<a class="btn btn-primary mb-2" href="{{ route('issues.create') }}"><i class="fa-solid fa-circle-plus"></i> Add
    Issue</a>
            ...
            @foreach($issues as $i)
                <tr>
                    ...
                    <td class="d-flex border-0 action-buttons" scope="row">
                        <a href="{{ route('issues.edit', $i->id) }}" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top"
